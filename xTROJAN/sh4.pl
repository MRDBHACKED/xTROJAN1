...
print color('bold red'),"\t\t        [";
print color('bold white'),"Coded BY SalaH KaDRi + FaRes Hanuti";
print color('bold white'),"FaCeBoOK SalaH : facebook.com/mr.virus39";
print color('bold white'),"FaCeBoOK FaReS : facebook.com/39.attack.dz";
print color('bold white'),"تــحياتي لهكر الجزائر و جميع  الدول العربية ";
print color('bold red'),"]\n";
print color('reset');
};
